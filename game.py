...
class Game:
    ...
    def setup(self):
        ...
        escalier_hall= Room("Escalier hall", "l'entrée où deux escaliers symétriques s’élèvent de part et d’autre du hall, leurs marches de pierre polie s’enfonçant dans une pénombre silencieuse.")
